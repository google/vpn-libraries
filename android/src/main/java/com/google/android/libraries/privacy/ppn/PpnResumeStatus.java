...
public class PpnResumeStatus {
  private final boolean isBlockingTraffic;
  private final boolean hasAvailableNetworks;

  public PpnResumeStatus(boolean isBlockingTraffic, boolean hasAvailableNetworks) {
  ...
  public String toString() {
    return "ResumeStatus{ isBlockingTraffic: "
        + isBlockingTraffic
  ...
  /*
   * Creates a PpnResumeStatus from its proto representation.
   *
   ...
   */
  public static PpnResumeStatus fromProto(ResumeStatus status) {
    return new PpnResumeStatus(status.getIsBlockingTraffic(), status.getHasAvailableNetworks());
  }
}
