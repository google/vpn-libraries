...
public class RouteManager {
  ...
  public static void addIpv4Routes(VpnService.Builder builder, boolean excludeLocalAddresses) {
    if (excludeLocalAddresses) {
  ...
  public static void addIpv6Routes(VpnService.Builder builder, boolean excludeLocalAddresses) {
    if (excludeLocalAddresses) {
