...
@class PPNNWPathMonitor;

NS_ASSUME_NONNULL_BEGIN

@protocol PPNNWPathMonitorDelegate <NSObject>

/**
 * Called when Xenon detects change in network.
 */
- (void)NWPathMonitor:(PPNNWPathMonitor *)pathMonitor
     didDetectNetwork:(::privacy::krypton::NetworkInfo)networkInfo;

/**
 * Called when Xenon detects no network available.
 */
