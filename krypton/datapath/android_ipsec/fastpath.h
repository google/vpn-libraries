...
#ifndef PRIVACY_NET_KRYPTON_DATAPATH_ANDROID_IPSEC_FASTPATH_H_
#define PRIVACY_NET_KRYPTON_DATAPATH_ANDROID_IPSEC_FASTPATH_H_
  ...
  class Forwarder {
   public:
    Forwarder(int source_fd, int destination_fd,
              const std::string& destination_ip_address, int port,
...
#endif  // PRIVACY_NET_KRYPTON_DATAPATH_ANDROID_IPSEC_FASTPATH_H_
