...
#ifndef PRIVACY_NET_KRYPTON_DATAPATH_ANDROID_IPSEC_SOCKET_UTIL_H_
#define PRIVACY_NET_KRYPTON_DATAPATH_ANDROID_IPSEC_SOCKET_UTIL_H_
...
#endif  // PRIVACY_NET_KRYPTON_DATAPATH_ANDROID_IPSEC_SOCKET_UTIL_H_
