...
#ifndef PRIVACY_NET_KRYPTON_DATAPATH_EVENTS_HELPER_H_
#define PRIVACY_NET_KRYPTON_DATAPATH_EVENTS_HELPER_H_
...
#endif  // PRIVACY_NET_KRYPTON_DATAPATH_EVENTS_HELPER_H_
